...
from bmeg_app.utils import help_button

help_cancer_screen=help_button.sidebar_button(
    'open1',
    'main_help1',
    'close1',
    '?',
    'Identify Drug Treatment Candidates from Cancer Cell Line Drug Screens',
    ['Interrogate cell line drug screening trials from large established sources (CCLE, CTRP, GDSC). Dig into drug sensitivity trends within a particular disease and explore associated metadata.','What’s going on behind the scenes?']
)
